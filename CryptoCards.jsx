...
const BitcoinCard = () => {
  ...
  return (
    <Card 
      ...
      buttonText={<Link to="/crypto/90">View Details</Link>}
      ID="90"
...
const EthereumCard = () => {
  ...
  return (
    <Card
      ...
      buttonText={<Link to="/crypto/80">View Details</Link>}
      ID="80"
      parameters={parameters}
...
const TetherCard = () => {
    ...
    return (
      <Card
        ...
        buttonText={<Link to="/crypto/518">View Details</Link>}
        ID="518"
        parameters={parameters}
...
const BNBCard = () => {
    ...
    return (
      <Card
        ...
        buttonText={<Link to="/crypto/2710">View Details</Link>}
        ID="2710"
        parameters={parameters}
...
const SolanaCard = () => {
    ...
    return (
      <Card
        ...
        buttonText={<Link to="/crypto/48543">View Details</Link>}
        ID="48543"
        parameters={parameters}
...
const XRPCard = () => {
    ...
    return (
      <Card
        ...
        buttonText={<Link to="/crypto/58">View Details</Link>}
        ID="58"
        parameters={parameters}
  ...
  const USDCCard = () => {
    ...
    return (
      <Card
        ...
        buttonText={<Link to="/crypto/33285">View Details</Link>}
        ID="33285"
        parameters={parameters}
  ...
  const CardanoCard = () => {
    ...
    return (
      <Card
        ...
        buttonText={<Link to="/crypto/257">View Details</Link>}
        ID="257"
        parameters={parameters}
  ...
  const AvalanceCard = () => {
    ...
    return (
      <Card
        ...
        buttonText={<Link to="/crypto/44883">View Details</Link>}
        ID="44883"
        parameters={parameters}
  ...
  const DogeCoinCard = () => {
    ...
    return (
      <Card
        ...
        buttonText={<Link to="/crypto/2">View Details</Link>}
        ID="2"
        parameters={parameters}
...
export { BitcoinCard, EthereumCard, TetherCard, BNBCard, SolanaCard, XRPCard, USDCCard, CardanoCard, AvalanceCard, DogeCoinCard };
